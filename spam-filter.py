...
# console.rule("[bold cyan]🧠 Training Logistic Regression Model[/bold cyan]")

# # ──────────────────────────────────────────────
# # 3️⃣ Scale Features
# # ──────────────────────────────────────────────
# console.print("[yellow]Scaling feature data...[/yellow]")
# scaler = StandardScaler()
# X_train_scaled = scaler.fit_transform(X_train)
# X_test_scaled = scaler.transform(X_test)
# console.print("[bold green]✅ Scaling Complete![/bold green]")

# # ──────────────────────────────────────────────
# # 4️⃣ Train Logistic Regression
# # ──────────────────────────────────────────────
# console.print("[yellow]Training LogisticRegression model...[/yellow]")
...
# # ──────────────────────────────────────────────
# joblib.dump(model, "spam_logistic_model.pkl")
# joblib.dump(scaler, "spam_scaler.pkl")

# console.rule("[bold cyan]💾 Saving Model[/bold cyan]")
# console.print(Panel.fit("[bold green]Model and scaler saved successfully![/bold green]\n"
#                         "🧠 [cyan]Model:[/cyan] spam_logistic_model.pkl\n"
#                         "⚙️ [cyan]Scaler:[/cyan] spam_scaler.pkl",
#                         border_style="green", title="Success"))
